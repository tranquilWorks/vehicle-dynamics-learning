# P07 walkthrough: Use the Bicycle Model

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you use the Bicycle Model?
...
This sequence is a build contract, not evidence that P07 is implemented.
