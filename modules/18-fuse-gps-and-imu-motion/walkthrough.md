# P18 walkthrough: Fuse GPS and IMU Motion

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you fuse GPS and IMU Motion?
...
This sequence is a build contract, not evidence that P18 is implemented.
