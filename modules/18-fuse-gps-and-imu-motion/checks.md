# P18 checks: Fuse GPS and IMU Motion
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you fuse GPS and IMU Motion?” without relying on MATLAB syntax.
