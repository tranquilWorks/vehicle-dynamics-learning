# P20 walkthrough: Identify Parameters from a Real Drive

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you identify Parameters from a Real Drive?
...
This sequence is a build contract, not evidence that P20 is implemented.
